...
namespace VacationManagement.Data
{
    public class VacationDbContext :DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SpGetReportsVactionPlans>().HasNoKey().ToSqlQuery("SpGetReportsVactionPlans");
        }
        ...
        public DbSet<SpGetReportsVactionPlans> SpGetReportsVactionPlans { get; set; }
    }
}
